...
class ResponseTest extends \Magento\TestFramework\TestCase\AbstractController
{
    ...
    /**
     * Tests the controller for created blocks used for sending emails that should not affect frontend response
     *
     * @param string $hash
     * @param string[] $params
     *
    ...
    public function testBlockCreationAffectingResult($hash, $params)
    {
        ...
        // create one block for potential frontend stack modification that should not affect response
